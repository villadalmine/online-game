...
async def collect_mines(
    ...
    for b in buildings:
        ...
        # SDD 66: mejora de producción por nivel (+output_mult) y condición (averiada rinde menos).
        pu = (spec.get("upgrade") or {}).get("production", {}).get("output_mult", 0)
        amount *= 1.0 + pu * max(0, (b.level or 1) - 1)
